...
/// 0-20 invariant.
/// Course ownership is NOT checked here -- it requires a database round-trip,
/// so it's enforced in RecordCourseGradeCommandHandler instead, per the
/// project's convention that FluentValidation validates input shape, not
/// cross-entity state.
/// </summary>
public class RecordCourseGradeCommandValidator : AbstractValidator<RecordCourseGradeCommand>
{
    public RecordCourseGradeCommandValidator()
    {
